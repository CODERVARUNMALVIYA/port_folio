...
export default function Hero() {
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white overflow-hidden">
      ...
      {/* Content */}
      <div className="hero-content relative z-10 max-w-6xl mx-auto px-4 py-16 grid md:grid-cols-2 gap-8 items-center">
        <div className="hero-copy">
          ...
          <p className="mt-4 text-lg text-gray-300">
            Passionate about creating dynamic websites that solve real problems with cutting-edge technology.
          </p>
