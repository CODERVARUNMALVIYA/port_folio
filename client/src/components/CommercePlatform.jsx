...
const products = [
  { id: 1, name: 'Aster Desk Lamp', category: 'Workspace', price: 84, stock: 24, rating: 4.8, image: 'https://images.unsplash.com/photo-1540932239986-30128078f3c5?w=700&q=80' },
  { id: 2, name: 'Everyday Carry Pack', category: 'Accessories', price: 128, stock: 8, rating: 4.9, image: 'https://images.unsplash.com/photo-1622560480605-d83c853bc5c3?w=700&q=80' },
  { id: 3, name: 'Arc Ceramic Set', category: 'Home', price: 56, stock: 31, rating: 4.7, image: 'https://images.unsplash.com/photo-1578749556568-bc2c40e68b61?w=700&q=80' },
  { id: 4, name: 'Studio Headphones', category: 'Tech', price: 219, stock: 12, rating: 4.9, image: 'https://images.unsplash.com/photo-1546435770-a3e426bf472b?w=700&q=80' },
  { id: 5, name: 'Linen Weekender', category: 'Accessories', price: 146, stock: 5, rating: 4.6, image: 'https://images.unsplash.com/photo-1553062407-98eeb64c6a62?w=700&q=80' },
  { id: 6, name: 'Mori Lounge Chair', category: 'Home', price: 489, stock: 4, rating: 4.8, image: 'https://images.unsplash.com/photo-1567016432779-094069958ea5?w=700&q=80' }
]
...
export default function CommercePlatform() {
  ...
  return (
    <div className="commerce-app">
      ...
      <main>
        <section className="commerce-hero"><div><p className="commerce-kicker">THE AUTUMN EDIT / 2026</p><h1>Objects with<br /><em>a point of view.</em></h1><p className="commerce-hero-copy">Considered goods for a more intentional everyday. Designed quietly, made to last.</p><a className="commerce-hero-link" href="#catalog">Explore the collection <span>↗</span></a></div><div className="hero-image"><img src="https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?w=1200&q=85" alt="Curated products arranged on a table" /><div className="hero-caption">01 / 04 <span>New work, better living</span></div></div></section>
